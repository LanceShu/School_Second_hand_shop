...
public class UserInfoRegister extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.e("num+password",num+"--------"+password);
        initWight();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.modefy:
                ...
                cursor.close();
                Snackbar.make(modify,"完成注册！",Snackbar.LENGTH_SHORT).show();
